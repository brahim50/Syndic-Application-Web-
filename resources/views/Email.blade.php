            ...
            <div class="container-fluid">
                ...
                <div class="card" style="position: relative;height: 380px;">
                    <div class="card-body wizard-content">
                        <h4 class="card-title">Envoyer Email</h4>
                        <h6 class="card-subtitle"></h6>
                        <form  action="{{ route('send.email')}}" method="POST" class="m-t-40" enctype="multipart/form-data">
                            @csrf 
                            <div>
                                <section>
                                    ...
                                    <input id="nom" name="nom" value="{{$user['nom']}}" placeholder="Nom" type="text" class="required form-control" style="position: relative;width: 50%" required>
                                    @error('nom') <span class="text-danger">{{$message}}</span>@enderror
                                    
                                    
                                    
                    
                                    <label for="email" style="position: relative;left:480px;bottom: 62px;">Email</label>
                                    <input id="email" name="email" type="email" value="{{$user['email']}}" placeholder="Email" class="required form-control" style="position: relative;width: 50%;left:480px;bottom: 64px;" required>
                                    @error('email') <span class="text-danger">{{$message}}</span>@enderror
                                    <label for="sub" style="position: relative;left:480px;bottom: 62px;">Subject</label>
                                    <input id="sub" name="sub" type="text"  placeholder="Subject" class="required form-control" style="position: relative;width: 50%;left:480px;bottom: 64px;" required>
                                    @error('sub') <span class="text-danger">{{$message}}</span>@enderror
                                    <label for="text" style="position: relative;bottom: 125px;">Text</label>
                                    <textarea id="text" name="text"  placeholder="Text" type="text" class="required form-control" style="position: relative;width: 50%;bottom: 128px;" required></textarea>
                                    @error('text') <span class="text-danger">{{$message}}</span>@enderror
                                    </div>
                                    <button type="submit"  class="btn btn-outline-warning" style="position: absolute;width: 60%;bottom:15px;left:150px;">Envoyer</button> 
                                </section>
                            </div>
                        </form>
                    </div>
