                    ...
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Gestion Des Dépenses </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="#" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span class="hide-menu"> Catégorie </span></a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="card" style="position: relative;height: 380px;">
                    <div class="card-body wizard-content">
                        ...
                        <form id="add_revenu_form"  action="{{route('add')}}" method="POST" class="m-t-40" enctype="multipart/form-data">
                            @csrf 
                            <div>
                                <section>
                                    ...
                                    <input id="lib" name="lib" placeholder="Libelle" type="text" class="required form-control" style="position: relative;width: 50%">
                                    
                                    <label for="col">Color</label>
                                    <select class="required form-control" name="col" placeholder="Select Category" id="lmmeuble" style="position: relative;width: 50%" >
                                        
                            <option  value="#f5143a" >Red</option>
                            <option  value="#def514" >Jaune</option>
                            <option  value="#9319b5" >Blueu</option>
                            <option  value="#32a852" >Vert</option>
                                    ...
                                    <button type="submit" id="add_revenu_btn" class="btn btn-outline-success" style="position: relative;width: 60%;top:30px;left:150px;">Ajouter</button> 
                                </section>
                            </div>
                        </form>
                    </div>
                ...
                <div class="card">
                    <div class="card-body" >
                        ...
                        <div class="table-responsive" id="show_all_lmmeuble">
                            ...
                            <div class="card" style="width: 18rem; background-color: {{$cate->col}};color:white;" >
                                <div class="card-body">
                                  <h5 class="card-title">{{$cate->lib}}</h5>
                                  
                                  <a href="#" id="{{$cate->id}}" class="btn btn-outline-danger deleteIcon">Delete</a>
                                </div>
                              </div>
          ...
          if (result.isConfirmed) {
            $.ajax({
              ...
              success: function(res) {
                ...
                Swal.fire(
                  'Deleted!',
                  'Your Categori has been deleted.',
                  'success'
                )
              }
            });
