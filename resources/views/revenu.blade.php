            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Gestion De Revenu</h4>
            ...
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Edit Revenu</h5>
                   ...
                   <div>
                       <section>
                           ...
                           @endforeach
                                   ...
                                   <select class="required form-control" name="appartement" placeholder="Select Category" id="appartement">
                        ...
                        @endforeach
                                   ...
                                   <label for="some">Somme</label>
                                    <input id="someEdit" name="somme" placeholder="Somme" type="number" class="required form-control" style="position: relative;width: 50%">
                                    <label for="date">Date</label>
                                    <input id="dateEdit" name="date" type="date" placeholder="Etage" class="required form-control" style="position: relative;width: 50%">
            ...
            <div class="container-fluid">
                ...
                <div class="card" style="position: relative;height: 380px;">
                    <div class="card-body wizard-content">
                        ...
                        <form id="add_revenu_form"  action="#" method="POST" class="m-t-40" enctype="multipart/form-data">
                            @csrf 
                            <div>
                                <section>
                                    <label for="lmmeuble">Lmmeuble</label>
                            ...
                            @endforeach
                                    ...
                                    <label for="some">Somme</label>
                                    <input id="some" name="somme" placeholder="Somme" type="number" class="required form-control" style="position: relative;width: 50%">
                                    <label for="date">Date</label>
                            ...
                            @endforeach
                                    ...
                                    <button type="submit" id="add_revenu_btn" class="btn btn-outline-success" style="position: relative;width: 60%;bottom:50px;left:150px;">Ajouter</button>
                                </section>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        ...
        $.ajax({
          ...
          success: function(res) {
            ...
            $("#appartement").val(res.appartement);
            $("#someEdit").val(res.somme);
            $("#dateEdit").val(res.date);
            $("#idEdit").val(res.id);
          }
        });
      });
      ...
      $("#edit_employee_form").submit(function(e) {
       ...
       $(document).on('click', '.deleteIcon', function(e) {
        ...
        $("#add_revenu_form").submit(function(e) {
        e.preventDefault();
        const fd = new FormData(this);
        $("#add_revenu_btn").text('Adding...');
        $.ajax({
            url: '{{ route('createrevenu') }}',
            method: 'POST',
            data: fd,
            cache: false,
            processData: false,
            ...
            success: function(res){
                if (res.status == 200) {
                  Swal.fire(
                    'Added!',
                    'Revunu Added Successfully!',
                    'success'
                  )
                  fetchAllAppartement();
                  
                }
                $("#add_revenu_btn").text('Ajouter');
                $("#add_revenu_form")[0].reset();
                $("#add_revenu_form").modal('hide');
            }
