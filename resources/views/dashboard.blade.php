            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-cyan text-center">
                                <h6 style="color: white;">Lmmeuble</h6>
                    ...
                    <div class="col-md-6 col-lg-4 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-success text-center">
                                <h6 style="color: white;">Appartement</h6>
                                <h6 class="text-white">{{$appar}}</h6>
                            </div>
                        </div>
                    </div>
                     <!-- Column -->
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-warning text-center">
                                <h6 style="color: white;">Revunu</h6>
                                <h6 class="text-white">{{$revu}}</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-danger text-center">
                                <h6 style="color: white;">Categorie</h6>
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-info text-center">
                                <h6 style="color: white;">Depense</h6>
                                <h6 class="text-white">{{$dep}}</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    ...
                    <div class="col-md-6 col-lg-4 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-danger text-center">
                                <h6 style="color: white;">Resident</h6>
                                <h6 class="text-white">{{$res}}</h6>
                            </div>
                        </div>
                    </div>
