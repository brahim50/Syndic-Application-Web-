            ...
            <div class="container-fluid">
                ...
                <div class="card" style="position: relative;height: 380px;">
                    <div class="card-body wizard-content">
                        <h4 class="card-title">Modifier un Depenses</h4>
                        <h6 class="card-subtitle"></h6>
                        <form id="add_revenu_form"  action="{{route ('updateDepense')}}" method="POST" class="m-t-40" enctype="multipart/form-data">
                            @csrf 
                            <div>
                                <section>
                                    <input type="hidden" name="id" value="{{$user['id']}}" >
                                    <label for="lmmeuble">Lmmeuble</label>
                                    <select class="required form-control" name="lmmeuble" value="{{$user['lmmeuble']}}" placeholder="Select Category" id="lmmeuble" style="position: relative;width: 50%" >
                            ...
                            @endforeach
                                    ...
                                    <input id="montant" name="montant" value="{{$user['montant']}}" placeholder="Montant" type="number" class="required form-control" style="position: relative;width: 50%">
                                    <label for="date">Date</label>
                                    <input id="date" name="date" value="{{$user['date']}}" type="date" placeholder="Etage" class="required form-control" style="position: relative;width: 50%">
                                    <label for="cat" style="position: relative;left:480px;bottom: 185px;">Catégorie</label>
                                    <select class="required form-control" name="cat" value="{{$user['cat']}}" placeholder="Select Category" id="appartement" style="position: relative;width: 50%;left:480px;bottom: 192px;" >
                            ...
                            @endforeach
                                    ...
                                    <input id="des" name="des" value="{{$user['des']}}" placeholder="Description" type="text" class="required form-control" style="position: relative;width: 50%;left:480px;bottom: 192px;">
                                    
                                    </div>
                                    <button type="submit" id="add_revenu_btn" class="btn btn-outline-warning" style="position: relative;width: 60%;bottom:75px;left:150px;">Update</button>
                                </section>
                            </div>
                        </form>
                    </div>
