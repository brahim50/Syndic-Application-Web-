            ...
            <nav class="navbar fixed-top top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{ asset('images/users/photo.png')}}" alt="user" class="rounded-circle" width="31"></a>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="#" aria-expanded="false"><i class="mdi mdi-border-inside"></i><span class="hide-menu">Gestion Des Revenus</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Gestion Des Dépenses </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                ...
                                <li class="sidebar-item"><a href="form-wizard.html" class="sidebar-link"><i class="mdi mdi-note-plus"></i><span class="hide-menu"> Détails </span></a></li>
                            </ul>
                        </li>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Gestion Des Depenses</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="card" style="position: relative;height: 380px;">
                    <div class="card-body wizard-content">
                        <h4 class="card-title">Ajouter un Depenses</h4>
                        <h6 class="card-subtitle"></h6>
                        <form id="add_revenu_form"  action="{{route ('create')}}" method="POST" class="m-t-40" enctype="multipart/form-data">
                            @csrf 
                            <div>
                                <section>
                            ...
                            @endforeach
                                    ...
                                    <input id="montant" name="montant" placeholder="Montant" type="number" class="required form-control" style="position: relative;width: 50%">
                                    <label for="date">Date</label>
                                    <input id="date" name="date" type="date" placeholder="Etage" class="required form-control" style="position: relative;width: 50%">
                                    <label for="cat" style="position: relative;left:480px;bottom: 185px;">Catégorie</label>
                                    <select class="required form-control" name="cat" placeholder="Select Category" id="appartement" style="position: relative;width: 50%;left:480px;bottom: 192px;" >
                                        @foreach($datappa as $cate)
                            <option  value="{{ $cate->lib }}">
                                {{ ucfirst($cate->lib) }}</option>
                            @endforeach
                                    </select>
                                    <label for="des" style="position: relative;left:480px;bottom: 185px;">Description</label>
                                    <input id="des" name="des" placeholder="Description" type="text" class="required form-control" style="position: relative;width: 50%;left:480px;bottom: 192px;">
                                    
                                    </div>
                                    <button type="submit" id="add_revenu_btn" class="btn btn-outline-success" style="position: relative;width: 60%;bottom:75px;left:150px;">Ajouter</button>
                                </section>
                            </div>
                        </form>
                    </div>
                            ...
                            <table id="zero_config" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{route ('deletedepense',$dep->id)}}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                            ...
                                            <a href="{{"EditDepanse/".$dep->id }}" <button type="button" class="btn btn-outline-warning editIcon"   style="position: relative;left:30px;bottom: 35px;"><i class="mdi mdi-pencil"></i></button></a>
