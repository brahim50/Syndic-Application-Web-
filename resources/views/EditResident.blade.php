            ...
            <div class="container-fluid">
                ...
                <div class="card" style="position: relative;height: 380px;">
                    <div class="card-body wizard-content">
                        <h4 class="card-title">Modifier un Résident</h4>
                        <h6 class="card-subtitle"></h6>
                        <form id="edit_employee_form"  action="" method="POST" class="m-t-40" enctype="multipart/form-data">
                            @csrf 
                            <div>
                                <section>
                                    <input type="hidden" name="id" value="{{$user['id']}}" >
                                    <label for="lmmeuble">Lmmeuble</label>
                                    <select class="required form-control" value="{{$user['lmmeuble']}}" name="lmmeuble" placeholder="{{$user['lmmeuble']}}" id="lmmeuble" style="position: relative;width: 50%" >
                            ...
                            @endforeach
                                    ...
                                    <input id="nom" name="nom" value="{{$user['nom']}}" placeholder="Nom" type="text" class="required form-control" style="position: relative;width: 50%">
                                    
                                    <label for="prenom" style="position: relative;left:480px;bottom: 62px;">Prenom</label>
                                    <input id="prenom" name="prenom" value="{{$user['prenom']}}" type="text" placeholder="Prenom" class="required form-control" style="position: relative;width: 50%;left:480px;bottom: 64px;">
                                    <label for="appartement" style="position: relative;left:480px;bottom: 185px;">Appartement</label>
                                    <select class="required form-control" name="appartement" value="{{$user['appartement']}}"  placeholder="Select Category" id="appartement" style="position: relative;width: 50%;left:480px;bottom: 192px;" >
                            ...
                            @endforeach
                                    ...
                                    <input id="ville" name="ville" value="{{$user['ville']}}" placeholder="Ville" type="text" class="required form-control" style="position: relative;width: 50%;bottom:125px;">
                                    <label for="email" style="position: relative;left:480px;bottom: 190px;">Email</label>
                                    <input id="email" name="email" type="email" value="{{$user['email']}}" placeholder="Email" class="required form-control" style="position: relative;width: 50%;left:480px;bottom: 190px;">
                                    <label for="tele"style="position: relative;left:3px;bottom:185px;" >Telephone</label>
                                    <input id="tele" name="tele" value="{{$user['tele']}}" placeholder="Telephone" type="text" class="required form-control" style="position: relative;width: 50%;bottom:185px;">
                                    <div class="col-md-9"  style="position: relative;width: 50%;left:480px;bottom: 220px;">
                                        <div class="custom-file">

                                            <input type="file" name="photo" value="{{$user['photo']}}" class="custom-file-input" id="validatedCustomFile" required>
                                            <label class="custom-file-label" for="validatedCustomFile">Choose Photo</label>
                                            
                                        </div>
                                    </div>
                                    </div>
                                    <button type="submit" id="edit_employee_btn" class="btn btn-outline-warning" style="position: relative;width: 60%;bottom:215px;left:150px;">Update</button> 
                                </section>
                            </div>
                        </form>
                    </div>
      ...
      $("#edit_employee_form").submit(function(e) {
        ...
        $.ajax({
          ...
          success: function(res) {
            ...
            $("#edit_employee_btn").text('Update Resident');
